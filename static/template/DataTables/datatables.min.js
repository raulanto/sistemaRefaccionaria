 ...
 *   https://datatables.net/download/#bs4-4.6.0/jq-3.7.0/dt-2.3.2/af-2.7.0/b-3.2.4/cc-1.0.7/date-1.5.6/fc-5.0.4/fh-4.0.3/kt-2.12.1/r-3.0.5/rg-1.5.2/rr-1.5.0/sc-2.4.3/sb-1.8.3/sp-2.3.4/sl-3.0.1
 *
 * Included libraries:
 *   Bootstrap 4 4.6.0, jQuery 3.7.0, DataTables 2.3.2, AutoFill 2.7.0, Buttons 3.2.4, ColumnControl 1.0.7, DateTime 1.5.6, FixedColumns 5.0.4, FixedHeader 4.0.3, KeyTable 2.12.1, Responsive 3.0.5, RowGroup 1.5.2, RowReorder 1.5.0, Scroller 2.4.3, SearchBuilder 1.8.3, SearchPanes 2.3.4, Select 3.0.1
 */
