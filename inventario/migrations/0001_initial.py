    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('proveedor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='contactos', to='inventario.proveedorempresa', verbose_name='Proveedor')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('activo', models.BooleanField(default=True)),
                ('nombre', models.CharField(db_index=True, max_length=60, verbose_name='Nombre de categoría')),
                ('descripcion', models.TextField(blank=True, verbose_name='Descripción')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado', models.CharField(choices=[('DISPONIBLE', 'Disponible'), ('AGOTADO', 'Agotado'), ('DESCONTINUADO', 'Descontinuado'), ('PEDIDO_ESPECIAL', 'Pedido especial'), ('PROXIMO AGOTARSE', 'Proximo')], default='DISPONIBLE', max_length=35, verbose_name='Estado del producto')),
                ...
                ('marca', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='productos', to='inventario.marcaproducto', verbose_name='Marca del producto')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('history_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL)),
                ('marca', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='inventario.marcaproducto', verbose_name='Marca del producto')),
